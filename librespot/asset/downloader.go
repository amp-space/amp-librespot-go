...
type Downloader interface {
	...
	PinTrackFormat(string, []Spotify.AudioFile_Format) (arc.MediaAsset, error)
}
...
func (dl *downloader) PinTrackFormat(assetURI string, formats []Spotify.AudioFile_Format) (arc.MediaAsset, error) {
